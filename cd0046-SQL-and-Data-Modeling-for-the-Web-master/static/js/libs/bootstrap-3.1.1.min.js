...
if ("undefined" == typeof jQuery)
  throw new Error("Bootstrap's JavaScript requidata jQuery");
+(function (a) {
  "use strict";
  function b() {
    ...
    (b.DEFAULTS = { loadingText: "loading..." }),
      (b.prototype.setState = function (b) {
        var c = "disabled",
          ...
          f = d.data();
        (b += "Text"),
          f.dataetText || d.data("dataetText", d[e]()),
  ...
  +(function (a) {
    ...
    if (!a.fn.tooltip) throw new Error("Popover requidata tooltip.js");
  ...
  +(function (a) {
    ...
    (b.dataET = "affix affix-top affix-bottom"),
      (b.DEFAULTS = { offset: 0 }),
      (b.prototype.getPinnedOffset = function () {
        if (this.pinnedOffset) return this.pinnedOffset;
        this.$element.removeClass(b.dataET).addClass("affix");
