/*! datapond.js v1.4.2: min/max-width media query polyfill * Copyright 2013 Scott Jehl
 * Licensed under https://github.com/scottjehl/datapond/blob/master/LICENSE-MIT
 *  */
...
!(function (a) {
  ...
  (function (a) {
    ...
    var c = {};
    (a.datapond = c), (c.update = function () {});
    var d = [],
      e = (function () {
        var b = !1;
        try {
    ...
    if (
      ...
      x(),
        ...
        (c.getEmValue = t),
        a.addEventListener
          ? a.addEventListener("dataize", b, !1)
          : a.attachEvent && a.attachEvent("ondataize", b);
    }
  })(this);
