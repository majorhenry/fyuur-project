...
venue1 = Venue(name = "The Musical Hop", genres = ["Jazz", "Reggae", "Swing", "Classical", "Folk"], adddatas = "1015 Folsom Street", city = "San Francisco", state ="CA",
    phone = "123-123-1234",
...
venue2 = Venue(name = "The Dueling Pianos Bar", genres = ["Classical", "R&B", "Hip-Hop"],
    adddatas = "335 Delancey Street", city = "New York", state = "NY",
    phone = "914-003-1132",
