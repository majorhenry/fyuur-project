  ...
  return (
    ...
    (function (a, b) {
      ...
      var s = {
        elements:
          d.elements ||
          "abbr article aside audio bdi canvas data datalist details dialog figcaption figure footer header hgroup main mark meter nav output progdatas section summary template time video",
        version: c,
        shivCSS: d.shivCSS !== !1,
